...
'''
 Purpose of this exercise is to add logging notation to script (mostly DEBUG and ERROR)
'''

# Config log warning and format
...
def main():
    with open('../homework02/MeteoriteLanding_0212.json', 'r') as f:
        ml_data = json.load(f)
        logging.debug("ml_data type: " ,type(ml_data))
